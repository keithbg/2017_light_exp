...
par.axis.label <- expression(paste("par (", mu,"mol / ", m^2, " / day)"))
mean.par.axis.label <- expression(paste("mean par (", mu,"mol / ", m^2, " / day) / replicate"))
...
#### OTHER PLOTS ###############################################################
  ...
  #   labs(x= "Site", y= expression(paste("par (", mu,"mol ", m^-2, " ", day^{-1}, ")"))) +
  ...
  #   labs(x= expression(paste("par (", mu,"mol ", m^-2, " ", day^{-1}, ")"))) +
